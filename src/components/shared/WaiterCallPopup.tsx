...
export default function WaiterCallPopup({ tableNumber, show }: WaiterCallPopupProps) {
  return (
    <div className={cn("fixed bottom-4 left-1/2 -translate-x-1/2 z-50 transition-transform duration-300 ease-in-out", show ? "translate-y-0 opacity-100" : "-translate-y-20 opacity-0")}>
